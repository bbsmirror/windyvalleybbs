...
#define SCHOOLNAME	"成大電機"		/* 組織名稱 */
#define BBSNAME		"風之谷"		/* 中文站名 */
#define BBSNAME2	"EEBBS"		/* 英文站名 */
#define SYSOPNICK	"風之精靈"		/* sysop 的暱稱 */
#define TAG_VALID       "[EEBBS]To"	/* 身分認證函 token */

#define MYIPADDR	"140.116.49.3"		/* IP address */
#define CURRENTVER  " 2009-10-18 Revision 55" /* 版本 */
#define MYHOSTNAME	"bbs.ee.ncku.edu.tw"	/* 網路地址 FQDN */

#define HOST_ALIASES	{MYHOSTNAME, MYIPADDR, \
			 "nckuee.twbbs.org", "nckueebbs.twbbs.org", \
			 NULL}

#define MYCHARSET	"BIG5"			/* BBS 所使用的字集 */

#define BBSHOME		"/home/bbs"		/* BBS 的家 */
#define BAKPATH		"/backup1"		/* 備份檔的路徑 */
...
#define Modules                         /* 啟用外掛 */
#define MAXGUEST            (15)        /* 最大guest人數 */
#define MAX_MAILHINTLINES    12         /* cache.081204: 收信宣言行數 */
#undef  BAD_POST                        /* cache.091018: 開啟劣退功能 */

  /* ------------------------------------------------- */
  /* 組態規劃˙外掛程式                                */
  /* ------------------------------------------------- */
  
#define M3_USE_PMORE   /* cache.080615: piaip's more                 */
#undef  BBSRuby        /* cache.081221: BBSRuby                      */ 
#define GRAYOUT        /* cache.090127: 淡入淡出特效                 */
#define SMerge         /* cache.090129: Smart Merge 修文自動合併     */
...
#define	SYSOP_CHECK_MAIL	/* itoc.001029: 站長可以讀取使用者信箱 */
...
#undef	NEWUSER_LIMIT		/* 新手上路的三天限制  cache.080307: 小站就算了吧...*/
...
#undef	HAVE_CHANGE_ID		/* 使用者名單 ^D 暫時更改 ID  cache.080307: 怕user去惡搞其他user */ 
...
#undef	HAVE_BRDMATE		/* itoc.020602: 板伴 (閱讀同一看板)  cache.080307: 人不多感覺很沒意義 */
...
#undef	ENHANCED_VISIT		/* itoc.010407: 已讀/未讀檢查是該看板的最後一篇決定 */
...
#define	HAVE_SCORE		/* itoc.020114: 文章評分功能  cache.080304: 是否開放推文功能 */
...
#define HAVE_LOCKEDMARK     /* hpo14.20070513: 提供看板文章鎖定 */

#define	HAVE_LABELMARK		/* itoc.020307: 提供看板文章加待砍標記 */

#define	POST_PREFIX		/* itoc.020113: 發表文章時標題可選擇種類  cache.080307: 要做到使用者可以自定才有意義*/
                        /*cache.080419: 此功能已改成在看板上設定*/
...
#define NOTE_MAX	10		/* 留言板保留篇數 */
#define NOTE_DUE	7		/* 留言板保留時間(天) */
...
#define	MAX_CROSS_POST		12	/* cross post 最大數量(篇)  cache.080307: 視情況調整 */
#define CROSSPOST_DENY_DAY	7	/* cross post 停權時間(天) */
#endif
...
#define BBSD_PORT	{23, 3456}	/* bbsd   所用的 port (bbsd.c)  cache.080307: open port 3456 */
...
#define BHTTP_PORT	8888	/* HTTP   所用的 port (bhttpd.c) */
