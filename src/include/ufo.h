...
#define UFO_HIDDEN  BFLAG(23)       /* 隱藏來源 */
...
#define UFO_DEFAULT_NEW		(UFO_MOVIE | UFO_BRDNOTE | UFO_BMWDISPLAY | UFO_NOSIGN)
...
#define STR_UFO     "-mpsnemPBQFANbwtSHZJ---hCHA"
