  ...
  char *msg;        /* bmw.msg 長度是 69 */
{
  ...
  if (!find)        /* 如果 rule 裡面沒有，就隨便回答 */
    { 
      ...
      {
      case 1:
        strcpy(msg, "不好意思我沒聽清楚，再說一遍吧");
        break;
      case 2:
        strcpy(msg, "等一下再說啦，我忙著回別人水球");
        break;
      case 3:
        strcpy(msg, "聽不太懂耶...");
        break;
      case 4:
        strcpy(msg, "你說的是中文嗎 = =a");
        break;
      case 5:
        strcpy(msg, "目前水球過多... 請稍後再丟我...");
        break;
      case 6:
        strcpy(msg, "<暫離>");
        break;
      case 7:
        ...
        break;
      case 8:
        strcpy(msg, "不好意思 >///< 先去洗澡囉");
        break;
      case 9:
        strcpy(msg, "聽不懂...");
        break;
      case 10:
        strcpy(msg, "<訊息無法傳達: 你已經被 npc 封鎖了>");
        break;
      case 11:
        strcpy(msg, "我想瞇一下，晚點再丟我好嗎");
        break;
      case 12:
        strcpy(msg, "=3=");
        break;
      ...
      case 16:
        ...
        break;
      case 17:
        strcpy(msg, "我在忙...sorry");
        break;
      case 18:
        strcpy(msg, "我只和正咩水球 抱歉啦 :P");
        break;
      case 19:
        strcpy(msg, "啦~啦~啦~");
        break;
      case 20:
        strcpy(msg, "抱歉...我現在不想說話 ˋˊ");
        break;
      case 21:
        strcpy(msg, "站長不准我和陌生人說話...");
        break;
      case 22:
        strcpy(msg, "聽不懂啦 聽不懂啦");
        break;
      case 23:
        strcpy(msg, "我累了= = 先去喝口水...");
        break;
      case 24:
        strcpy(msg, "嘿嘿");
        break;
      ...
      case 26:
        ...
        break;
      case 27:
        strcpy(msg, "換個話題好嗎... 我的AI有限...");
        break;
      case 28:
        strcpy(msg, "I can't understand...");
        break;
      case 29:
        strcpy(msg, "What ?!");
        break;
      case 30:
        strcpy(msg, "AI怪怪的... 我不知道這個時候該說什麼");
        break;
      case 32:
        strcpy(msg, "資料不足... 無法回答...");
        break;
      case 33:
        strcpy(msg, "XD");
        break;
      case 34:
        strcpy(msg, "你累了... 聽首歌好嗎");
        break;
      case 35:
        strcpy(msg, "GN粒子不足，無法回應");
        break;
      case 36:
        strcpy(msg, "<文字辨識功\能失效，重新開機ing...>");
        break;
      case 37:
        strcpy(msg, "GN-Drive 啟動中...");
        break;
      case 38:
        strcpy(msg, "逼逼逼逼");
        break;
      case 39:
        strcpy(msg, "煩耶，這麼愛丟水球不會去丟站長喔");
        break;
      case 40:
        strcpy(msg, "講太小聲了，我聽不到");
        break;
      default:
        strcpy(msg, "有什麼可以為您服務的嗎");
        break;
      }
    }
}
...
bmw_rqst()
{
  ...
  if (j)
  {
    ...
    do
    {
      ...
      if (!strcmp(cuser.userid, "GUNDAM"))  /* NPC 的 ID 是 "NPC" */
      {
        if (mptr->caller)
        {
          BMW new;
...
/*080907.cache: 這段有點問題,會造成npc斷線,日後再修正*/
